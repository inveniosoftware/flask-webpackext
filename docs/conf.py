...
html_theme_options = {
    ...
    'github_repo': 'flask-webpackext',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'flask-webpackext@GitHub': 'https://github.com/inveniosoftware/flask-webpackext',
        'flask-webpackext@PyPI': 'https://pypi.python.org/pypi/flask-webpackext/',
    }
}
...
htmlhelp_basename = 'flask-webpackext_namedoc'
...
latex_documents = [
  (master_doc, 'flask-webpackext.tex', u'flask-webpackext Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'flask-webpackext', u'flask-webpackext Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'flask-webpackext', u'Flask-WebpackExt Documentation',
   author, 'flask-webpackext', 'Webpack integration for Flask.',
   'Miscellaneous'),
]
